(() => {
  ...
  function initialState() {
    ...
    const orders = [
      makeOrder(masters, {
        ...
        staff: 'サンプル担当A',
        rentHandler: 'サンプル担当B',
        orderFileUrl: 'sample_document.html?type=order&id=OP-202604-001',
        deliveryFileUrl: 'sample_document.html?type=delivery&id=OP-202604-001',
      ...
      makeOrder(masters, {
        ...
        staff: 'サンプル担当D',
        rentHandler: 'サンプル担当A',
        orderFileUrl: 'sample_document.html?type=order&id=OP-202604-003',
        deliveryFileUrl: '',
        deliverySentAt: '',
        status: '有効',
        note: '確認用に状態のよいものを選定。'
      ...
      makeOrder(masters, {
        ...
        staff: 'サンプル担当B',
        rentHandler: '',
        orderFileUrl: 'sample_document.html?type=order&id=OP-202604-004',
        deliveryFileUrl: 'sample_document.html?type=delivery&id=OP-202604-004',
  ...
  function getState() {
    try {
      ...
      window.__MOBILE_ORCHARD_SAMPLE_STATE__ ||= initialState();
  ...
  const api = {
    ...
    sendDeliveryNote(password, orderId, toAddress, ccAddress, subject, bodyText) {
      ...
      order.deliveryFileUrl = 'sample_document.html?type=delivery&id=' + encodeURIComponent(orderId);
      saveState(state);
      return {
        ok: true,
        sentTo: toAddress,
